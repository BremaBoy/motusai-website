...
const footerStyles = `
  footer {
    padding: 0 max(32px, calc((100vw - 910px) / 2)) 24px;
    background: #f7f7f7;
  }
  ...
  .footer-group h4 { margin: 0; color: #6f6f6f; font-weight: 400; }
  ...
  .footer-bottom button { padding: 10px 20px; border: 0; border-radius: 999px; background: #111; color: #fff; }
